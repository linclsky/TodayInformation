...
import today.news.annotation.MvpEmptyViewFatory;
...
public class MvpEmptyViewProcesor {
    ...
    public void process(RoundEnvironment roundEnvironment, MvpProcessor mvpProcessor) {
        ...
        try {
            ...
            for (TypeElement element : ElementFilter.typesIn(roundEnvironment.getElementsAnnotatedWith(MvpEmptyViewFatory.class))) {
            ...
            javaFile.writeTo(mvpProcessor.mFiler);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
